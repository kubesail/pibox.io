      ...
      <div className={styles.secondDrawer}>
        <div className={styles.secondDrawerContent}>
          <div className={styles.secondDrawerCopy}>
            ...
            <p>The first NAS that lets you use a standard operating system that you’re used to, like Ubuntu or Raspberry Pi OS.</p>
          </div>
        ...
        <div className={styles.thirdDrawerContent}>
          ...
          <div className={styles.thirdDrawerCopy}> 
            ...
            <Image 
                ...
                height={64}
                />
                <p>With the Raspberry Pi’s native 4K h.265 native video decoder, the PiBox makes a great media center.</p>
          </div>
        </div>
      </div>
